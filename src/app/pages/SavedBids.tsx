      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">{savedBids.length} saved bids</p>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="bg-gradient-to-r from-indigo-600 to-blue-600 p-6 text-white">
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    <h2 className="text-2xl mb-1">Formal Bid Document</h2>
                    <p className="text-indigo-100 text-sm">{selectedBid.tenderName}</p>
                  </div>
                  <button
                    onClick={() => {
                      setShowBidDocument(false);
                ...
                <div className="mt-4 flex items-center gap-3">
                  <div className="bg-white/20 rounded-lg px-3 py-2">
                    <p className="text-xs text-indigo-100 mb-1">Match Score</p>
                    <p className="text-sm">{selectedBid.matchScore}%</p>
                  </div>
                  {!isEditingDocument && (
                    <button
                      onClick={() => setIsEditingDocument(true)}
                      className="flex items-center gap-2 px-4 py-2 bg-white/20 rounded-lg hover:bg-white/30 transition-all text-sm"
                    >
                      <Edit2 className="w-4 h-4" />
                  ...
                  {isEditingDocument && (
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-green-500 rounded-lg hover:bg-green-600 transition-all text-sm"
                      >
                      ...
                      <button
                        onClick={() => setIsEditingDocument(false)}
                        className="px-4 py-2 bg-white/20 rounded-lg hover:bg-white/30 transition-all text-sm"
                      >
                        Cancel
                      </button>
                    </div>
              ...
              <div className="border-t border-gray-200 p-6 bg-gray-50">
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-indigo-700 hover:to-blue-700 transition-all shadow-md hover:shadow-lg"
                  >
                    Download PDF
                  </button>
                  <button
                    ...
                    className="px-6 py-3 bg-white text-gray-600 rounded-xl hover:bg-gray-100 transition-colors border border-gray-300"
                  >
                    Close
                  </button>
                </div>
          ...
          >
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl text-gray-900 mb-2">Delete Bid?</h3>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-red-600 text-white px-6 py-3 rounded-xl hover:bg-red-700 transition-all shadow-md hover:shadow-lg"
                >
                  Yes, Delete
                </button>
                <button
                  onClick={handleCancelDelete}
                  className="flex-1 bg-white text-gray-600 px-6 py-3 rounded-xl hover:bg-gray-100 transition-colors border border-gray-300"
                >
                  Cancel
                </button>
              </div>
